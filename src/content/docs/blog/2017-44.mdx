...
description: ゲーム, AppleTV, Elgato Eve, Caskroom の話。雑多に。
date: 2017-10-29
---
...
![](/img/blog/2017-44/20171029213545.jpeg)
...
![](/img/blog/2017-44/20171029215734.jpeg)

また、これだけでは終わらせる気もない。IR Kitも購入したので、homebridgeを使った独自オートメーションもそろそろ進めようかなーと思ってる。
...
今はチームの内情などを鑑みながら、プロダクトオーナーに近い立ち位置で、チーム全体にロードマップやアイディアを配れるようになることを目標にしている。やってみて相当大変ではあるが、数年もかかるほどの目標ではないよなぁと感じていて、5年後、10年後にそれをずっとやっていたいかと言われると、それはちょっと違うかなぁと。
...
<X url="https://twitter.com/legnoh/status/924329036100222978" />
