...
description: ヒゲ脱毛を開始したのでその所感。 PC見直しの話も。
date: 2017-12-03
---
...
自宅のPC環境は、これまで4年くらいベースマシンとなっていたiMacをベースに会社からの貸与端末を使う構成にしていた。ここから今のモチベーションの変化を鑑みて、iMacを売り、macbook + mac mini + iPad の小さい端末を複数持つ構成に切り替えようと考えている。
...
<X url="https://twitter.com/legnoh/status/934695475738849280" />
