...
現在、家で使ってるWin7、WinVista、MBAのVMWareFusion内のWin8、大学のMacのVMWareFusion内にWin7+Win8とWindows端末(?)を5台持っている。このうちOfficeが入ってるのはほぼお蔵入り状態のVista(Office2007)のみで、過去使っていたOfficeドキュメントなんかをデザインそのままに開けず困っていた。
