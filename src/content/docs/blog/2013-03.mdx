...
<OGLinkCard url="http://toggtc.hatenablog.com/entry/2012/02/20/230500" />

最新版のTeX Live 2012を用いてTeXを書けるようになるまでのチュートリアル。
これでもか！というレベルで懇切丁寧に書かれているのと、homebrewを用いたモダンな構成のおかげで慣れれば1時間弱でセットアップが終わる。

環境変えたりTeXを長期間使わなかったりした機会が何度かあった。その度に苦労して構成した環境が吹っ飛んでることもよくあり、ほとほと困っていたので、このエントリは本当に助かった。UTF-8でやってくれていたのも都合上非常に便利だった。
...
うちの研究室には卒論のテンプレ、と呼ばれるようなものもないみたいで、先輩の残したtexファイルがテンプレ化してるような感じだった。
